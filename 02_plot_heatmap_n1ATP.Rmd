...
htheme <- function() {
  swi_theme(y_gridlines = F, title_family = "OpenSans-CondensedBold") + 
    theme(
      ...
      legend.title = element_text(
        size = 13, family = "OpenSans-CondensedBold", hjust = 0.5, vjust = 1),
...
for (lang in colnames(txt)) {
  ...
  hatp <- ggplot(n1r) + 
    ...
    scale_fill_gradientn(
      name = "ATP ranking",
      colours = rev(colorRampPalette(brewer.pal(9,"RdPu"))(255)), #viridis(1000, option = "D"),
    ...
    scale_x_date(
      ...
      expand = c(0, 0), 
      limits = c(min(n1r$dates), max(n1r$dates) + 2300)
    ) +
  ...
  hatp2 <- hatp + geom_text(
    ...
    family = "OpenSans-CondensedLight", size = 3.7, color="#737373"
  ) + geom_segment(
    data = anno, 
    aes(x = x0, xend = x1, y = y0, yend = y1),
    colour = '#a6a6a6', alpha = 0.5, size = 0.15,
